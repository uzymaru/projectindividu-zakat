<?php
include('donasilogin.php'); // Memasuk-kan skrip Login
    ...
    <div class="container">
			  ...
			  <fieldset>
					...
					<form action="" method="post">
                        ...
                        <td><div class="call-action-but" style="text-align:center;"><a href="donasi_daftar.php">Daftar</a></div></td>
						</tr>
						</table>
					</form>
				</fieldset>
