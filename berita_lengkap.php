...
<body>
    ...
    <div class="container">
				<p><?
    $query = "SELECT A.id_berita, B.nm_kategori, A.judul, A.isi, A.tanggal FROM berita A, kategori_berita B WHERE A.id_kategori=B.id_kategori AND A.id_berita='$id_berita'";
 ...
 //tampilkan berita
 echo "<h3>$judul</h3><br>";
 echo "<small><b>$tanggal</b> dalam kategori <b>
			$kategori</b></small><br>";
 echo "<p>$isi</p>";
 ?> </p>
			</article>
