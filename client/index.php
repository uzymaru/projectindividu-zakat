...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
                                                ...
                                                <i class="fa fa-bars"></i>
                                                      ...
                                                      <div class="collapse navbar-collapse" id="menu">
                                                            <ul class="nav navbar-nav navbar-right">
                                                                  ...
                                                                  <li><a href="#buku"><h6>Buku</h6></a></li>
                                                                  <li><a href="#contact"><h6>Contact</h6></a></li>
																  <li><a href="donasi.php" class="btn btn-skin"><h5>Donasi</h5></a></li>
                                                            </ul>
                                                      </div>
                                                      <!-- /.Navbar-collapse -->
    ...
    <section id="about" class="home-section color-dark bg-white">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
			<p>Rumah Zakat Al-Ikhlas adalah sebuah cita-cita besar dari penggagasnya dalam usaha untuk merubah sebuah kebiasaan umum yang sudah berlaku sejak dahulu; malas membaca pada masyarakat Kepulauan Kei.
	...
	<!-- Section: works -->
    <section id="buku" class="home-section color-dark text-center bg-white">
		<div class="container marginbot-50">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					<div class="wow flipInY" data-wow-offset="0" data-wow-delay="0.4s">
					<div class="section-heading text-center">
					<h2 class="h-bold">KOLEKSI BUKU Rumah Zakat Al-Ikhlas</h2>
					<div class="divider-header"></div>
					<p>Lorem ipsum dolor sit amet, agam perfecto sensibus usu at duo ut iriure.</p>
					</div>
					</div>
