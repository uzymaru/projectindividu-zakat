...
<!-- Navigation -->
                                                ...
                                                <i class="fa fa-bars"></i>
                                                      ...
                                                      <div class="collapse navbar-collapse" id="menu">
                                                            <ul class="nav navbar-nav navbar-right">
                                                                  <li class="active"><a href="index.php"><h6>Home</h6></a></li>
    ...
    <!-- berita -->
    <section class="home-section color-dark bg-gray">
        <div class="container marginbot-50">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="wow flipInY" data-wow-offset="0" data-wow-delay="0.4s">
                    <div class="section-heading text-center">
                    <h2 class="h-bold">Berita Terbaru</h2>
        ...
        <div class="text-center">
            ...
            <div class="columns content welcome-box large-12">
				<!-- tab panes -->
						...
						<?php echo"$r[judul_berita]"; ?></h1>
                <div class="row">
                    <div class="col-md-12 text-left">
						<?php echo"<img style='max-width:400px; margin:10px;' class='pull-left img-responsive img-thumbnail' src='berita/foto/$r[gambar]'><br><br>"; ?>
						<p style="margin-top:-45px;"><?php echo"$r[isi_berita]"; ?></p>
    					<br class="clear" />
                    </div>
                </div>      
			</div>
