...
<div class="columns content welcome-box large-12">
              <?php
              // include "koneksi.php";
              $query = "select * from kategori,berita where berita.kategori=kategori.id_kategori order by berita.id_berita desc";
              ...
              ?>
                          <table class="table-striped table">
                            ...
                            <tr bgcolor="#E4E4E4">
                              ...
                              <td><small><a class="btn btn-info" href="readmore.php?id_berita=<?php echo $data['id_berita']; ?>">Read more</a></small></td>
                            </tr>
                                  <?php
                                  $no++;
                                  }
